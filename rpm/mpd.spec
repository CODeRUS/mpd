...
Source4:        mpd_firewalld.xml
Patch0:         mpd-0.19-mpdconf.patch
...
install -p -D -m 0640 %{SOURCE4} \
    $RPM_BUILD_ROOT%{_sysconfdir}/firewalld/services/mpd.xml
...
%{_sysconfdir}/firewalld//services/mpd.xml
...
%changelog
* Sun Apr 19 2015 Jure Kobal <kobalj AT gmail DOT com> - 1:0.19.9-1
- Updated to the latest upstream releas 0.19.9
